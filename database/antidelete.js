...
const AntiDeleteDB = database.define('antidelete', {
    ...
    notification: {
        ...
        defaultValue: '• 📩 𝗗𝗲𝗹𝗲𝘁𝗲𝗱 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 𝗥𝗲𝗰𝗼𝘃𝗲𝗿𝗲𝗱                • 📜 𝗪𝗮𝗻𝘁 𝗬𝗼𝘂𝗿 𝗢𝘄𝗻 𝗕𝗼𝘁❓                   • 🪀 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗧𝗼 𝗕𝘂𝘆: +923309341706                                      • 👑🄰🅁🅂🄻🄰🄽 🄲🄷🄰🅄🄳🄰🅁🅈',
        allowNull: false
    },
    includeGroupInfo: {
        type: DataTypes.BOOLEAN,
...
async function getAntiDeleteSettings() {
    try {
        ...
        return { 
            status: true, 
            notification: '• 📩 𝗗𝗲𝗹𝗲𝘁𝗲𝗱 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 𝗥𝗲𝗰𝗼𝘃𝗲𝗿𝗲𝗱                • 📜 𝗪𝗮𝗻𝘁 𝗬𝗼𝘂𝗿 𝗢𝘄𝗻 𝗕𝗼𝘁❓                   • 🪀 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗧𝗼 𝗕𝘂𝘆: +923309341706                                      • 👑🄰🅁🅂🄻🄰🄽 🄲🄷🄰🅄🄳🄰🅁🅈',
